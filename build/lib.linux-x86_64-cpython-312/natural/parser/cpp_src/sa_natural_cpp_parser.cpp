...
antlr4::tree::ParseTree* get_parse_tree_program(NaturalParser *parser) {return parser->program();}

antlr4::tree::ParseTree* get_parse_tree(NaturalParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(NaturalParser*)> table
    {
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Parse
        NaturalParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_NaturalTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_natural_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_natural_cpp_parser(void) {
